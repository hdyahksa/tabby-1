...
import MemberFilter from "./member_filter.png";
...
- **Chat usage**: Track chat usage in both the IDE extensions and the Answer Engine

You can use the Member Filter (top of page) to analyze:
- **Team-level**: Usage across all members
- **Individual-level**: Usage for specific users

<img src={MemberFilter} width={700} alt="Analytics Member Filter" />
